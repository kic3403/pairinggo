...
export type PickKey = "expert" | "public" | "member" | "profile";
export const PICK_LABEL: Record<PickKey, string> = { expert: "전문가픽", public: "대중픽", member: "회원픽", profile: "맛 분석" };
/** 같은 묶음 안의 세부 출처 이름 */
export const PICK_DETAIL: Record<SrcTier, string> = {
  official: "양조장 공식", sommelier: "소믈리에·명인", media: "매체 보도", blog: "블로그·유튜브 후기", user: "회원 추천", profile: "맛 프로필 추정", ai: "AI 추정",
};
