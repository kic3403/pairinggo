  ...
  return (
    <>
      ...
      <main>
        ...
        <StoreForm phone={phone} info={info} drinks={cat.drinks} foods={cat.foods} siteUrl={process.env.NEXT_PUBLIC_SITE_URL || "https://pairinggo.vercel.app"} kakaoId={merchant.kakaoPlaceId} />
      </main>
      <Tabs active="store" />
    </>
  );
