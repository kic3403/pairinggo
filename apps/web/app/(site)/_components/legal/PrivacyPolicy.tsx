...
export const COLLECTION_ROWS: { when: string; items: string; purpose: string }[] = [
  ...
  { when: "서비스를 이용할 때", items: "저장한 전통주·음식·음식점, 먹어봤어요 평가, 술 평가(별점·한 줄), 회원 추천 글·사진·하트, 검색어, 화면 방문·링크 클릭 기록, 로그인 시각·실패 횟수", purpose: "저장·평가·추천 기능 제공, 페어링 통계와 서비스 개선, 부정 로그인 방지" },
