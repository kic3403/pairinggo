...
export const COLLECTION_ROWS: { when: string; items: string; purpose: string }[] = [
  ...
  { when: "식당을 예약할 때", items: "휴대폰 번호(문자 인증), 예약자 이름, 방문 일시·인원, 요청사항, 룸 희망·술 지참 여부, 고른 페어링, 예약·취소·방문 기록, 알림을 켠 기기의 알림 주소", purpose: "예약 확정·취소 처리와 매장 전달, 예약 알림(문자·알림톡·웹 푸시), 노쇼·부정 예약 방지, 이메일 회원의 비밀번호 재설정(인증한 번호로 본인 확인)" },
