 ...
 * 이벤트: screen · search(서버에서 search_logs 직접) · buy_link_click · restaurant_link_click · external_link · save · restaurant_list · card_tap · rate(먹어봤어요 평가)
 ...
 */
export type WebEventName = "screen" | "buy_link_click" | "restaurant_link_click" | "external_link" | "save" | "restaurant_list" | "card_tap" | "rate" | "member_pick" | "pick_like";
